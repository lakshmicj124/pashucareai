...
DATASET_DIR = Path(r"c:\Users\DELL\Documents\cow disease project\dataset\sheep")
MODEL_DIR = Path(r"c:\Users\DELL\Documents\cow disease project\ai-model")
MODEL_PATH = MODEL_DIR / "sheep_model.pkl"
...
CLASSES_MAP = {
    ...
    "diseased_sheep": "Sheep Scab (Psoroptic Mange)",
...
def train_model():
    ...
    print(f"\n[SUCCESS] Best sheep model saved to: {MODEL_PATH}")
